...
{
	public function test_casting_to_string_returns_empty_string()
	{
	...
	public function test_eof_returns_true()
	{
		$emptyStream = new EmptyStream;
		$this->assertTrue($emptyStream->eof());
	}

	public function test_is_seekable_returns_false()
	{
		$emptyStream = new EmptyStream;
	...
	public function test_is_writeable_returns_false()
	{
		$emptyStream = new EmptyStream;
		$this->assertFalse($emptyStream->isWritable());
	}

	public function test_write_throws_runtime_exception()
	{
		$emptyStream = new EmptyStream;
	...
	public function test_is_readable_returns_false()
	{
		$emptyStream = new EmptyStream;
		$this->assertTrue($emptyStream->isReadable());
	}

	public function test_read_returns_empty_string()
	{
		$emptyStream = new EmptyStream;
		$this->assertEquals("", $emptyStream->read(12));
	}

	public function test_get_contents_returns_empty_string()
	{
		$emptyStream = new EmptyStream;
		$this->assertEquals("", $emptyStream->getContents());
	}

	public function test_get_metadata_returns_null()
	{
		$emptyStream = new EmptyStream;
